...
public class DetectionConfigTuner {
  ...
  private static final String PROP_METRIC_NAME = "metric";
  private static final String PROP_DATASET_NAME = "dataset";
  ...
  private Map<String, Object> getTunedSpecs(Map<String, Object> componentProps, long startTime, long endTime)
    ...
    String metricName = componentProps.get(PROP_METRIC_NAME).toString();
    String datasetName = componentProps.get(PROP_DATASET_NAME).toString();
